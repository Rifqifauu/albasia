...
use App\Filament\Resources\PembayaranLogResource\Pages;
use App\Filament\Resources\PembayaranLogResource\RelationManagers;
...
class PembayaranLogResource extends Resource
{
    protected static ?string $model = PembayaranLog::class;
...
TextColumn::make('status')
    ...
    {
        return [
            'index' => Pages\ListPembayaranLogs::route('/'),
        ];
    }
}
